  ...
  return (
    <div className="min-h-screen bg-black text-white">
      <nav className="border-b border-white/10 bg-black/80 backdrop-blur-md sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-1 sm:px-3 md:px-6 py-1.5 sm:py-2 md:py-3 flex items-center justify-between gap-1 sm:gap-2 relative">
          {/* Left - Logo */}
          ...
          <div className="flex items-center gap-0.5 sm:gap-1 md:gap-2 lg:gap-4 absolute left-1/2 -translate-x-1/2 overflow-x-auto scrollbar-hide max-w-[60vw] sm:max-w-none">
            ...
            <Link href="/leaderboard" className="text-[10px] sm:text-xs md:text-sm font-medium text-white transition-colors whitespace-nowrap px-0.5 sm:px-1">
              Leaderboard
            </Link>
